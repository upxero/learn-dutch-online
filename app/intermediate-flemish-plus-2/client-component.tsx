...
export default function BeginnersPlusClient() {
  ...
  const items = [
    { label: "Les 11 - Interculturele communicatie", link: "https://sites.google.com/view/int-flem-plus-11-25-01/deel-1-discussie" },
    { label: "Les 12 - Slapen op het werk", link: "https://sites.google.com/view/int-flem-plus-12-25-01/deel-1-discussie" },
    { label: "Les 13 - Sparen", link: "https://sites.google.com/view/int-flem-plus-13-25-01/deel-1-discussie" },
    { label: "Les 14 - Mens en dier", link: "https://sites.google.com/view/int-flem-pl-14-25-01/deel-1-discussie" },
  ];
