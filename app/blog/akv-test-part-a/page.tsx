...
export default function AKVSummaryPresentationBlog() {
  return (
    <>
      <HeroBlog />
      <main className="max-w-3xl mx-auto px-4 py-8 text-gray-800">
        ...
        <ul className="mb-6 list-disc list-inside">
          ...
          <li>Mental health psychologist</li>
        ...
        >
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2">Tips for presenting:</h3>
          ...
          <p>
            At Learn Dutch Online we love guiding you through this process and help you with the presentation and summary. <span className="text-blue-600 cursor-pointer">Contact us here</span> for more information.
          </p>
        </Section>
      </main>
    </>
