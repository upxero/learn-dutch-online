      ...
      <main className="max-w-3xl mx-auto px-4 py-8 text-gray-800">
        ...
        >
          <>
            ...
            <ol className="list-decimal list-inside mb-4">
              <li>Details and history of the patient. This is the basic description of the patient and any potential medical history you may have been given about them.</li>
              <li>Reason for the visit. What ailment or symptom motivated their visit.</li>
              <li>Complaints of the patient. Their experience of the patient regarding the ailment.</li>
              <li>The patients outlook. How the patient perceives the influence of this ailment on living their life normally in the future.</li>
              <li>Advice and instructions you have given. The instructions given to the patient to overcome or manage their condition.</li>
              <li>Mutual agreements. What you and you patient agreed on and the actions to be taken in future.</li>
            </ol>
            <p>
        ...
        <p className="mb-6">
          Would you like to get in contact with a language trainer to help you prepare for this exam? Contact us here and we will gladly assist you!
        </p>
